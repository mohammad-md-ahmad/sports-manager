const Constants = {
    ...
    apiUrl: 'http://192.168.1.102:81/api', // Mohammad A. local server
    ...
    assetsUrl: 'http://192.168.1.102:81/storage', // Mohammad A. local server
    imagesUrl: 'http://192.168.1.102:81/files/images', // Mohammad A. local server
    tokenKey: 'auth_token',
